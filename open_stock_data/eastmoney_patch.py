...
_DEFAULT_PUSH2_SLEEP_RANGE = (0.5, 1.2)  # 更长的请求间隔，避免触发限流
_DEFAULT_PUSH2_MAX_CONCURRENCY = 2  # 降低并发，减少连接中断
_DEFAULT_PUSH2_MIN_INTERVAL_SECONDS = 0.8  # 更长的最小间隔
_DEFAULT_PUSH2_MAX_RETRIES = 3  # 增加重试次数
_DEFAULT_PUSH2_RETRY_BACKOFF_SECONDS = 2.0  # 更长的重试间隔
